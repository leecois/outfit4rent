                ...
                Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20),
                        boxShadow: [
                          BoxShadow(color: const Color(0xFF4A5367).withOpacity(0.3), offset: const Offset(0, 3), blurRadius: 5),
                          BoxShadow(color: const Color(0xFF4A5367).withOpacity(0.3), offset: const Offset(0, 30), blurRadius: 30)
                        ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text("Welcome to Outfit4Rent", textAlign: TextAlign.center, style: TextStyle(fontFamily: "Inter", fontSize: 17, fontWeight: FontWeight.w600)),
                        const SizedBox(height: 24),
                        const Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            "Email",
                            style: TextStyle(color: CupertinoColors.secondaryLabel, fontFamily: "Inter", fontSize: 15),
                          ),
                        ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "OR",
                                  style: TextStyle(color: Colors.black.withOpacity(0.3), fontSize: 15, fontFamily: "Inter"),
                                ),
                              ),
                              const Expanded(child: Divider()),
                            ],
                        ...
                        const Text("Sign up with Email, Apple or Google", style: TextStyle(color: CupertinoColors.secondaryLabel, fontFamily: "Inter", fontSize: 15)),
                        const SizedBox(height: 24),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [Image.asset(TImages.logoEmail), Image.asset(TImages.logoApple), Image.asset(TImages.logoGoogle)],
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: CupertinoButton(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: const Color(0xFF4A5367).withOpacity(0.3),
                              blurRadius: 5,
...
InputDecoration authInputStyle(String iconName) {
  return InputDecoration(
      ...
      prefixIcon: Padding(padding: const EdgeInsets.only(left: 4), child: Image.asset("assets/images/social/$iconName.png")));
}
