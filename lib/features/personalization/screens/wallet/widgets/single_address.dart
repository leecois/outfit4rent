      ...
      child: Stack(
        children: [
          Positioned(
            ...
            top: 0,
            child: Icon(
              selectedAddress ? Iconsax.tick_circle_outline : null,
          ...
          Column(
            ...
            children: [
              ...
              const Text('(+84) 94720391 ', maxLines: 1, overflow: TextOverflow.ellipsis),
              const SizedBox(height: TSizes.sm / 2),
              const Text('Thu Duc, Ho Chi Minh', softWrap: true),
            ],
          ),
        ],
      ),
