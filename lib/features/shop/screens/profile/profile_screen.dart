...
import 'package:outfit4rent/common/widgets/header.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: ListView(padding: const EdgeInsets.symmetric(horizontal: 16), physics: const BouncingScrollPhysics(), children: <Widget>[
        ...
        //     InfoCard(title: 'localization_title', content: 'localization_content', icon: FluentIcons.local_language_24_regular, isPrimaryColor: true),
        //     InfoCard(title: 'linting_title', content: 'linting_content', icon: FluentIcons.code_24_regular, isPrimaryColor: false),
        //     InfoCard(title: 'storage_title', content: 'storage_content', icon: FluentIcons.folder_open_24_regular, isPrimaryColor: false),
        //     InfoCard(title: 'dark_mode_title', content: 'dark_mode_content', icon: FluentIcons.weather_moon_24_regular, isPrimaryColor: true),
        //     InfoCard(title: 'state_title', content: 'state_content', icon: FluentIcons.leaf_three_24_regular, isPrimaryColor: true),
        //     InfoCard(title: 'display_title', content: 'display_content', icon: FluentIcons.top_speed_24_regular, isPrimaryColor: false),
        //   ],
        // ),
